...
class Reservas extends Controller{
    ...
    public function solicitar(){
        ...
        if (empty($id_cli) || empty($id_veh) || empty($cantidad) || empty($precios) || empty($fecha)) {
            ...
            if (empty($existe)) {
                $data = $this->model->registrarReserva($fecha, $fecha_devolucion, $cantidad, $precios,
                $monto, $fecha_reserva, $observacion, $id_veh, $id_cli);
                if ($data > 0) {
