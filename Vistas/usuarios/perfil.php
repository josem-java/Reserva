...
<div class="row">
    ...
    <div class="col-lg-5 col-md-5 col-sm-12">
        <div class="card text-center">
            <div class="card-body">
                <img class="img-thumbnail" src="<?php echo base_url . 'Activos/img/users/' . $data['perfil'] ?>" width="150" alt="">
                <ul class="list-group">
...
<script src="<?php echo base_url . 'Activos/js/pages/perfil.js'; ?>"></script>
