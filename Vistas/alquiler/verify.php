        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <ul class="list-group">
                    ...
                    <li class="list-group-item"><img class="img-thumbnail" src="<?php echo base_url . 'Activos/img/vehiculos/' . $data['vehiculo']['foto']; ?>" alt=""></li>
                </ul>
            </div>
            <div class="col-md-6">
                <?php //COMPROBAR TIPO
                ...
                <ul class="list-group mb-3">
                    ...
                    <li class="list-group-item"><b><?php echo $tipo; ?></b><?php echo $data['reserva']['cantidad']; ?></li>
...
<script src="<?php echo base_url . 'Activos/js/pages/verify.js'; ?>"></script>
