                ...
                <ul class="list-group">
                    <?php foreach ($data['vehiculos'] as $car) { ?>
                        <li class="list-group-item cars <?php echo (!empty($_GET['car']) && $_GET['car'] == $car['id']) ? 'bg-warning' : ''; ?>" id="<?php echo $car['id']; ?>">
                            <img class="img-thumbnail" width="50" src="<?php echo base_url . 'Activos/img/vehiculos/' . $car['foto']; ?>" alt="">
...
<script src="<?php echo base_url; ?>Activos/vendors/fullcalendar/js/main.min.js"></script>
<script src="<?php echo base_url; ?>Activos/js/es.global.min.js"></script>

<?php if ($_SESSION['tipo'] == 2) { ?>
    <script src="<?php echo base_url; ?>Activos/js/pages/reservas.js"></script>
<?php } else { ?>
    <script>
