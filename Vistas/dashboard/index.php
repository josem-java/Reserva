                        ...
                        <div class="form-group">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <img class="img-thumbnail" id="img-preview" src="<?php echo base_url; ?>Activos/img/<?php echo $data['empresa']['logo']; ?>" width="200">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="<?php echo base_url; ?>Activos/js/pages/dashboard.js"></script>
</body>
